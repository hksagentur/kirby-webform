 ...
 */
abstract class Collection implements Arrayable, Countable, Htmlable, Jsonable, JsonSerializable, IteratorAggregate, Stringable
{
    /**
    ...
    /**
     * @template TPipeValue of Collection
     *
     ...
     *
     * @param TMergeValue[]|Collection<TKey, TMergeValue> $components
